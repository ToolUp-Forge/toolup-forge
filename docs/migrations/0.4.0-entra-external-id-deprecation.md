...
>
> Reason 1 (the dual-button sign-up affordance via `EntraExternalIdAuthUI.wrap`) is **unchanged** and remains a legitimate reason to stay on the companion. This document is otherwise historical and is not being rewritten.
