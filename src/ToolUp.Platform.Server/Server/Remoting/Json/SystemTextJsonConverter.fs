namespace ToolUp.Remoting.Json.SystemTextJson
...
// =============================================================================
//
// Wire format (matches ToolUp.Remoting.Json.FableJsonConverter byte-for-byte):
//
...
module FableConverters =
    /// Register the full ToolUp.Remoting STJ converter set on an existing
    ...
    /// Create a fresh JsonSerializerOptions with the full ToolUp.Remoting STJ
