                ...
                if streamingShape.IsSome then
                    ...
                    try
                        ...
                        let stjOptions =
                            ...
                            | NewtonsoftJson ->
                                // Streaming + legacy Newtonsoft is unsupported in v0.
                                invalidOp "Phase 69c streaming requires SystemTextJson serializer backend"
                    ...
                    let! resolvedAuthContextForRequest =
                        task {
                                            ...
                                            let! payload =
                                                task {
                                                    ...
                                                    | Some inputT ->
                                                        ...
                                                        | NewtonsoftJson -> return Map.empty
                                                    | None -> return Map.empty
                                                }
        ...
        | FromContextAsync createImplementationFromAsync ->
            ...
            fun (next: HttpFunc) (ctx: HttpContext) ->
                task {
                    ...
                    return! GiraffeUtil.buildFromImplementation (fun _ -> impl) options next ctx
                }
