# Changelog — ToolUp.Platform.NotificationChannels.Email.SendGrid

All notable changes to the `ToolUp.Platform.NotificationChannels.Email.SendGrid` package are recorded here.
