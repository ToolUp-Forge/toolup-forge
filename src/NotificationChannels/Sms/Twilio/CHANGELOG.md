# Changelog — ToolUp.Platform.NotificationChannels.Sms.Twilio

All notable changes to the `ToolUp.Platform.NotificationChannels.Sms.Twilio` package are recorded here.
